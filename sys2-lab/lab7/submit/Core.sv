...
module Core (
    ...
    logic flush_exe;
    logic valid_exe;
    addr_t pc_exe, next_pc_exe, target_addr_exe;
    imm_t imm_exe;
    ...
    assign next_pc_if = switch_mode ? pc_csr : (br_taken_exe ? target_addr_exe : (pc_if + 4));
    ...
    assign flush_if = br_taken_exe || switch_mode || trap_pending;
    assign flush_id = br_taken_exe || switch_mode || trap_pending;
